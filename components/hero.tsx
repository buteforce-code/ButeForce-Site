...
export default function Hero() {
  // The hero clip is heavy, so the poster carries first paint and the <video>
  // is only mounted after hydration — and never for reduced-motion visitors.
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-end pb-20 pt-32 overflow-hidden bg-black">
      ...
      {/* Poster paints immediately; the video fades in over it once it can play. */}
      <div
      ...
      <div className="relative max-w-site mx-auto px-6 lg:px-10 w-full z-10">
        ...
        {/* The headline */}
        <h1 className="text-4xl md:text-5xl lg:text-7xl xl:text-[4.5rem] font-display font-bold text-white leading-[1.1] tracking-tight mb-6 max-w-5xl">
        ...
        <FadeContent delay={0.3}>
          <h2 className="font-display font-semibold text-xl md:text-2xl text-white/85 drop-shadow-sm leading-snug mb-6 max-w-3xl">
