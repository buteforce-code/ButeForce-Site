        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-4" staggerDelay={0.1}>
          {SERVICES.map((service, i) => (
            <Link
              ...
              className="block w-full h-full group relative bg-surface-off shadow-sm border border-surface-border rounded-card p-8 hover:border-ink/20 hover:shadow-md transition-all duration-200 overflow-hidden"
            >
